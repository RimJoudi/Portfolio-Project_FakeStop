      ...
      <div class="col-12 col-md-8 col-lg-8 col-xl-6">
        <div class="row">
          <div class="col text-center">
            <h1>Verify Diploma Authenticity</h1>
            <br/>
            <p class="text-h3">Put The ID Of The Diploma Owner</p>
          </div>
          </div>
          <form onSubmit={this.submitHandlerr}> 
                <div class="row align-items-center">
                  <div class="col mt-4">
                    <input type="text" class="form-control" placeholder="National_identification_number"
